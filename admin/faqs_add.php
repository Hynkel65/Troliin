...
if (isset($_POST['question'])) {
    ...
    if (!empty($question) && !empty($abstract) && !empty($answer) && !empty($category)) {
                ...
                <div class="form-outline mb-4">
                    <div class="form-outline mb-4">
                        <select name="category" class="form-select" id="category">
                            ...
                            <option value="2">Troubleshooting and Technical Issues</option>
                            <option value="3">Privacy and Security</option>
                            <option value="4">Contact and Supports</option>
                            <option value="5">Legal and Terms of Service</option>
                        </select>
                    </div>
                </div>
